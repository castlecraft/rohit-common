...
def get_account_root_type_map(company):
	"""Returns a dictionary mapping each account to its root_type."""
	return frappe._dict(
		frappe.get_all("Account", fields=["name", "root_type"], filters={"company": company}, as_list=1)
	)